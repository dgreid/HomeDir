...
# pull 11 since it won't build with this one 
patch -R -p0 < /scratch/Defender/Balboa/7200/STLinuxKernelPatches/090804/11_*
# cd to the build directory and kick off the build
cd /opt/STM/STLinux-2.3/devkit/build/havana-build.cb104_mc
make all